...
describe('LineTool', () => {
  ...
  it('can create new line', () => {
    ...
    expect(lineTool.shape.shapeProperties.secondaryColor).toEqual(colorsService.primaryColor);
    expect(lineTool.shape.shapeProperties.primaryColor).toEqual(colorsService.secondaryColor);
